...
const experiences = [
  {
    ...
    duration: "2024",
    description:
      "Collaborated with a team to build high-performance React applications, focusing on seamless UI/UX and optimized features to significantly improve user engagement.",
  },
  
  {
    role: "Web Developer Intern",
    company: "Alram Business Solution",
    duration: "2025",
    description:
