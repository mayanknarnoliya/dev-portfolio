        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build scalable, modern applications with a strong focus on clean architecture, delightful UX, and performance. My toolkit React, Next.js, TypeScript, Tailwind CSS, and FastAPI—bringing ideas to life from concept to production with robust APIs and smooth interfaces.
            </p>

            {/* Quick stats */}
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                { label: "Experience", value: " 7+ month" },
                { label: "Specialty", value: "Full Stack" },
                { label: "Focus", value: "Performance & High Availability Systems" },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I’m a Software Developer, and Web Developer — passionate about building fast, resilient applications and sharing coding insights on Github.
            </p>
